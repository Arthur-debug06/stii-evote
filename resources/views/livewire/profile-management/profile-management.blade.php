    ...
    <div class="col-span-12 flex flex-col-reverse lg:col-span-4 lg:block 2xl:col-span-3">
        <div
            ...
            <div class="relative flex items-center p-5">
                <span data-content=""
                    class="tooltip border-(--color)/5 block relative flex-none overflow-hidden rounded-full border-3 ring-1 ring-(--color)/25 [--color:var(--color-primary)] size-12">
                    @php
                        $profileImage = null;

                        // Prefer explicit DB paths using route-based serving
                        if ($user && $user->profile_image && \Illuminate\Support\Facades\Storage::disk('public')->exists($user->profile_image)) {
                            $profileImage = route('public.file', ['path' => $user->profile_image]);
                        } elseif ($user && $user->student_id_image && \Illuminate\Support\Facades\Storage::disk('public')->exists($user->student_id_image)) {
                            $profileImage = route('public.file', ['path' => $user->student_id_image]);
                        } elseif ($userType === 'student' && $user) {
                            // Fallback: Check student_images directory for profile images
                            ...
                            if (is_dir($studentImagesPath)) {
                                ...
                                if (!empty($files) && file_exists($files[0])) {
                                    $profileImage = route('public.file', ['path' => 'student_images/' . basename($files[0])]);
                                }
                            }
                        }
                    @endphp
                    ...
                    @if($profileImage)
                        <img class="absolute top-0 size-full object-cover" src="{{ $profileImage }}"
                            alt="{{ $user->first_name ?? 'User' }} {{ $user->last_name ?? '' }}">
                    @else
                        <div
                            class="absolute top-0 size-full bg-primary/20 flex items-center justify-center text-primary font-semibold">
                            @if($userType === 'student')
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    ...
                                    stroke-linejoin="round" class="lucide lucide-user mr-3 text-primary">
                                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                    <circle cx="12" cy="7" r="4"></circle>
                                </svg>
                                <div>
                                    <div class="text-sm font-medium text-foreground">Full Name</div>
                                    <div class="text-sm text-muted-foreground">{{ $user->first_name ?? 'N/A' }}
                                        {{ $user->last_name ?? 'N/A' }}</div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-mail mr-3 text-primary">
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-book-open mr-3 text-primary">
                                    <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path>
                                    <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path>
                                </svg>
                                <div>
                                    <div class="text-sm font-medium text-foreground">Course</div>
                                    <div class="text-sm text-muted-foreground">{{ $user->course->course_name ?? 'N/A' }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-building mr-3 text-primary">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-muted-foreground">
                                        {{ $user->department->department_name ?? 'N/A' }}</div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-calendar mr-3 text-primary">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-muted-foreground">
                                        {{ $user->school_year_and_semester->school_year ?? 'N/A' }} -
                                        {{ $user->school_year_and_semester->semester ?? 'N/A' }}</div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-id-card mr-3 text-primary">
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-heart mr-3 text-primary">
                                    <path
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-muted-foreground">{{ ucfirst($user->marital_status ?? 'N/A') }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-shield mr-3 text-primary">
                    ...
                    @else
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-activity mr-3 text-primary">
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-muted-foreground">
                                        {{ $user->created_at ? $user->created_at->format('M d, Y') : 'N/A' }}</div>
                                </div>
                            </div>
                        </div>
                    @endif
        ...
        @if($showOtpModal)
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div
                        class="bg-(--color)/20 border-(--color)/60 text-(--color) flex cursor-pointer items-center rounded-full border px-2 py-px text-xs ml-auto [--color:var(--color-primary)]">
                        Required
                    </div>
                </div>
                <div class="mt-4 text-center">
                    ...
                    <p class="text-sm text-gray-600 mb-4">
                        Please enter the 6-digit OTP sent to your email address to complete the
                        {{ $changeType === 'password' ? 'password change' : 'email change' }}.
                    </p>
                    ...
                    <div class="flex justify-center mb-4">
                        <input wire:model="otpCode" type="text" maxlength="6"
                            ...
                            placeholder="000000" autocomplete="off" x-data="{ otp: @entangle('otpCode') }" x-model="otp"
                    ...
                    <div class="text-center text-sm text-gray-500 mb-4">
                        <div class="mb-2">
                            ...
                            <span class="font-mono font-bold text-red-600" x-data="{ timeLeft: 600 }"
                ...
                <div class="mt-5 flex font-medium">
                    <button type="button" wire:click="cancelOtpVerification"
                        class="cursor-pointer inline-flex border items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border-gray-300 text-gray-700 hover:bg-gray-50 h-10 px-4 py-2 w-28 bg-transparent"
                        type="button">
                        Cancel
                    </button>
                    <button type="button" wire:click="verifyOtp"
                        class="cursor-pointer inline-flex border items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border-(--color)/60 text-(--color) hover:bg-(--color)/5 [--color:var(--color-primary)] h-10 px-4 py-2 ml-auto w-28 bg-transparent"
                        type="button">
                        Verify
                    </button>
                </div>
                ...
                <div class="flex items-center border-b px-5 py-5 sm:py-3">
                    ...
                    <button wire:click="updateProfile"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            data-lucide="save"
                            class="lucide lucide-save stroke-[1.5] [--color:currentColor] stroke-(--color) fill-(--color)/25 mr-2 size-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-4">
                                        @if($user && $user->profile_image && \Illuminate\Support\Facades\Storage::disk('public')->exists($user->profile_image))
                                            <img src="{{ route('public.file', ['path' => $user->profile_image]) }}"
                                        ...
                                        @endif
                                        <div>
                                            <input type="file" wire:model="new_profile_image" accept="image/*"
                                                class="text-sm text-gray-500">
                                            <p class="text-xs text-gray-500 mt-1">JPG, PNG or GIF (Max. 2MB)</p>
                                            @error('new_profile_image') <span
                        ...
                        @else
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        @error('first_name') <span class="text-red-500 text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        @error('middle_name') <span class="text-red-500 text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        @error('last_name') <span class="text-red-500 text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        @error('marital_status') <span class="text-red-500 text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                ...
                <div class="flex items-center border-b px-5 py-5 sm:py-3">
                    ...
                    <button wire:click="changePassword"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            data-lucide="lock"
                            class="lucide lucide-lock stroke-[1.5] [--color:currentColor] stroke-(--color) fill-(--color)/25 mr-2 size-4">
                    ...
                    <form wire:submit.prevent="changePassword" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                @error('current_password') <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('new_password') <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>

                            <!-- Confirm Password -->
                            <div>
                                <label class="block text-sm font-medium text-foreground mb-2">Confirm New
                                    Password</label>
                                <div class="relative">
                                    <input type="{{ $show_confirm_password ? 'text' : 'password' }}"
                                ...
                                @error('confirm_password') <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
